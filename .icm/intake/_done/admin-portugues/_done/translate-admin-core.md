...
> `translate-calendar` — which re-inventories the component first, because PR #31
> (`booking-live/land-availability-pools`) merged as `89046bb` mid-recut and rewrote it
> by ~390 lines. No work was done against this slug.
