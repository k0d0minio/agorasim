...
You pick the pieces you want now; the rest slot in later on the same foundation, at the same prices,
whenever you're ready.

> **A note on pricing.** This is a **friends-and-favour rate** — I still need to be paid for the
> work, but these are deliberately not agency prices. Every figure is a **one-time build fee** in
> EUR: no retainer, no monthly subscription, no lock-in. Future changes are one-off, priced as they
> come. The prices are also kept low because a lot of the technical foundation already exists in
> your toolkit (the bilingual site, the GEO groundwork, the lead database, the admin dashboard) —
> so these cover **finishing and shipping** real features, not building from zero. Every number is
> adjustable; tell me what feels right.

---

## 2. How to read this proposal

- **Build price** — a one-time, fixed fee to design, build, test and launch that feature. That's it.
- **Running costs** — a few third-party services (Stripe, SMS, email, AI, hosting) are paid
  **directly to those providers, at cost** — never to me, and never as a fee I charge (Section 6).
...
|---|---------|------------:|--------------|
| 1 | Website + GEO optimization | **€1,400** | Foundation built — needs completion & polish |
| 2 | AI-automated blog | **€900** | Database ready — pipeline to build |
| 3 | Instant tour booking + Stripe payments | **€1,600** | New (currently FareHarbor) |
| 4 | Instant wedding-car-hire booking | **€900** | New _(€600 if taken with #3)_ |
| 5 | Social media generator + auto-poster | **€1,300** | Research done — build to do |
| 6 | Referral / word-of-mouth system | **€800** | New |
| 7 | Email & SMS notifications | **€700** | New |
| 8 | CRM pipeline tracker | **€700** | Basic version already live — to upgrade |
| 9 | Email marketing (past & archived guests) | **€800** | Database ready — sender to build |
| | **Full suite (all nine)** | **~€7,900** | **Save ~€1,200 vs. buying separately** |

Each feature is described below.

---

### Feature 1 — Website with GEO optimization · €1,400
...
the GEO libraries. This price finishes the content, hardens the GEO layer, and ships it to
production.
...
### Feature 2 — AI-automated blog · €900
...
### Feature 3 — Instant tour booking + Stripe payments · €1,600
...
### Feature 4 — Instant wedding-car-hire booking · €900 _(€600 with Feature 3)_
...
### Feature 5 — Social media generator + auto-poster · €1,300
...
- **Generator (€600)** — AI writes captions, hashtags and a posting calendar; you approve in the
  dashboard. Low-risk, immediate value.
- **Auto-poster (€700)** — connects to the platforms' *official* APIs to publish approved posts
  automatically.
...
Facebook** (the ones that matter most for a Portuguese tour business) and adding others later.
...
### Feature 6 — Referral / word-of-mouth system · €800
...
### Feature 7 — Email & SMS notifications · €700
...
### Feature 8 — CRM pipeline tracker · €700
...
### Feature 9 — Email marketing for past & archived guests · €800
...
|--------|------:|-------------------|
| **Gift vouchers / gift cards** | €700 | Sell experiences as gifts (Christmas, birthdays) — paid upfront, redeemed later. Great cash flow, and buyers become new customers. |
| **Google Reviews + testimonials wall** | €400 | Pull your Google reviews onto the site automatically. Social proof is the #1 booking driver, and review count also boosts GEO/AI ranking. |
| **Analytics & revenue dashboard** | €600 | One screen: bookings, revenue, top experiences, conversion, referral performance. Know what's working. |
| **WhatsApp Business integration** | €550 | You already run on phone contact — let guests book/ask via WhatsApp, with templated confirmations. Portugal lives on WhatsApp. |
| **Extra tourist languages** (ES / FR / DE) | €350 each | Your foundation is bilingual; adding the languages your international guests actually speak widens the funnel cheaply. |
| **Abandoned-booking recovery** | €400 | Auto-email people who started booking but didn't finish. Typically recovers 5–15% of lost bookings. |
| **Loyalty / repeat-guest program** | €750 | Reward guests for coming back or trying new add-ons (Manzwine, Ramilo, Olaria MZ). Pairs with the referral system. |
| **Partner / affiliate portal** | €900 | Let your add-on partners (wineries, Tasco Galapito) and hotels/concierges refer bookings and track commission. Turns partners into a sales channel. |
| **GDPR & cookie-consent kit** | €300 | EU-compliant consent, privacy policy, data handling. Cheap insurance, and required for email marketing. |
| **Accessibility & performance audit** | €350 | WCAG + speed pass. Better for all users, and both feed SEO/GEO ranking. |
...
**≈ €3,000** _(wedding bundle price applied)_
...
## 6. Running costs (third-party — paid directly to the providers, never to me)

These are the only recurring costs in the whole project, and **none of them are a fee I charge** —
they're paid straight to the service providers, at cost, and most scale to zero when you're quiet.
...
A new business typically runs **€20–70/month** in third-party costs early on, rising gently with
volume. I don't touch any of it — you hold the accounts.

---

## 7. What we need from you & rough timeline

- **From you:** brand assets (logo, photos), access to your domain, social accounts (for posting),
  and a Stripe account (I'll help set it up). Quick reviews of drafts as we go.
- **Timeline:** most single features land in **1–2 weeks**; a full phase in **3–5 weeks**. We agree
  exact dates once you choose.
- **Payment:** typically 50% to start a feature/phase, 50% on launch. That's the whole arrangement —
  no ongoing bills.
...
- [ ] 1 · Website + GEO — €1,400
- [ ] 2 · AI blog — €900
- [ ] 3 · Tour booking + Stripe — €1,600
- [ ] 4 · Wedding-car booking — €900 _(€600 with #3)_
- [ ] 5 · Social generator + poster — €1,300
- [ ] 6 · Referral system — €800
- [ ] 7 · Email & SMS notifications — €700
- [ ] 8 · CRM pipeline — €700
- [ ] 9 · Email marketing — €800
- [ ] **Full suite — €7,900**
...
<!-- All prices are one-time build fees at a friends-and-favour rate, fully editable.
     No retainer or monthly subscription; third-party running costs are paid directly to providers. -->
